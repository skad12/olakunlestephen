...
export default function Home() {
  return (
    <>
      ...
      <div
        className="min-h-screen pt-5 lg:pt-10 antialiased bg-cover "
        style={{
      ...
      >
        <div className="p-16 pt-12 lg:space-y-10 space-y-5 ">
          <div>
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M17.25 6.75L22.5 12l-5.25 5.25m-10.5 0L1.5 12l5.25-5.25m7.5-3l-4.5 16.5" />
      ...
      Contact
            ...
            <div className=" lg:flex justify-center lg:space-x-5 lg:pt-6">
              {/* <div className="font-bold flex justify-center">Stack:</div> */}

              <div className="flex justify-center space-x-5 lg:space-x-10">
            <div >
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" className="h-10 w-10 lg:h-32 lg:w-32 hover:h-52 hover:w-52 "
viewBox="0 0 48 48"
style={{color:"fill:#000000;"}}><path fill="#E65100" d="M41,5H7l3,34l14,4l14-4L41,5L41,5z"></path><path fill="#FF6D00" d="M24 8L24 39.9 35.2 36.7 37.7 8z">
  </path><path fill="#FFF" d="M24,25v-4h8.6l-0.7,11.5L24,35.1v-4.2l4.1-1.4l0.3-4.5H24z M32.9,17l0.3-4H24v4H32.9z"></path>
  ...
  <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" className="h-10 w-10 lg:h-32 lg:w-32 hover:h-52 hover:w-52"
viewBox="0 0 48 48"
style={{color:"fill:#000000;"}}><path fill="#0277BD" d="M41,5H7l3,34l14,4l14-4L41,5L41,5z"></path><path fill="#039BE5" d="M24 8L24 39.9 35.2 36.7 37.7 8z"></path>
...
<path fill="#000001" d="M29.538,32.947c0.692,1.124,1.444,2.201,3.037,2.201c1.338,0,2.04-0.665,2.04-1.585 c0-1.101-0.726-1.492-2.198-2.133l-0.807-0.344c-2.329-0.988-3.878-2.226-3.878-4.841c0-2.41,1.845-4.244,4.728-4.244 c2.053,0,3.528,0.711,4.592,2.573l-2.514,1.607c-0.553-0.988-1.151-1.377-2.078-1.377c-0.946,0-1.545,0.597-1.545,1.377 c0,0.964,0.6,1.354,1.985,1.951l0.807,0.344C36.452,29.645,38,30.839,38,33.523C38,36.415,35.716,38,32.65,38 c-2.999,0-4.702-1.505-5.65-3.368L29.538,32.947z M17.952,33.029c0.506,0.906,1.275,1.603,2.381,1.603 c1.058,0,1.667-0.418,1.667-2.043V22h3.333v11.101c0,3.367-1.953,4.899-4.805,4.899c-2.577,0-4.437-1.746-5.195-3.368 L17.952,33.029z">
  ...
  <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" className="h-10 w-10 lg:h-32 lg:w-32 hover:h-52 hover:w-52"
viewBox="0 0 48 48"
style={{color:"fill:#000000;"}}><path fill="#80deea" d="M24,34C11.1,34,1,29.6,1,24c0-5.6,10.1-10,23-10c12.9,0,23,4.4,23,10C47,29.6,36.9,34,24,34z M24,16	c-12.6,0-21,4.1-21,8c0,3.9,8.4,8,21,8s21-4.1,21-8C45,20.1,36.6,16,24,16z"></path>
...
<path fill="#80deea" d="M33,44.6c-5,0-12.2-6.1-17.6-15.6C8.9,17.8,7.6,6.9,12.5,4.1l0,0C17.4,1.3,26.2,7.8,32.7,19	c3,5.2,5,10.6,5.6,15.2c0.7,4.9-0.3,8.3-2.8,9.8C34.7,44.4,33.9,44.6,33,44.6z M13.5,5.8c-3.3,1.9-2.7,11.3,3.6,22.2	c6.3,10.9,14.1,16.1,17.4,14.2c1.7-1,2.3-3.8,1.8-7.8c-0.6-4.3-2.5-9.4-5.4-14.4C24.6,9.1,16.8,3.9,13.5,5.8L13.5,5.8z">
  </path><circle cx="24" cy="24" r="4" fill="#80deea"></circle>
  </svg>
  </div>
